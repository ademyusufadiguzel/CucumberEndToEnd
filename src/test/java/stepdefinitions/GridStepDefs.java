...
public class GridStepDefs {
    ...
    public void user_is_on_the_homepage_by_chrome(String url) throws MalformedURLException {
        ...
        driver = new RemoteWebDriver(new URL("http://192.168.18.9:4444"),new ChromeOptions());
    ...
    public void userIsOnTheHomepageByEdge(String url) throws MalformedURLException {
        ...
        driver = new RemoteWebDriver(new URL("http://192.168.18.9:4444"),new EdgeOptions());
        driver.manage().window().maximize();
        driver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);
        driver.get(url);
    ...
    public void userIsOnTheHomepageByFirefox(String url) throws MalformedURLException {
        ...
        driver = new RemoteWebDriver(new URL("http://192.168.18.9:4444"),new FirefoxOptions());
        driver.manage().window().maximize();
        driver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);
        driver.get(url);
